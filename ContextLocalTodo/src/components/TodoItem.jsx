    ...
    return (
        <div
            className={`flex border border-black/10  rounded-lg  px-3 py-1.5 gap-x-3 shadow-sm shadow-white/50 duration-300
             text-black ${todo.completed ? "bg-[#7afcff]" : "bg-[#ff7eb3]"}`}
        >
            <input type="checkbox"
            ...
            />
            <button
                className='inline-flex w-8 h-8 rounder-lg text-sm border  border-black/10 justify-center
                  text-center  bg-gray-100 shrink-0
                   disabled:opacity-50'
                onClick={() => {
